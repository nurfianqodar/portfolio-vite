...
import AnimateInView from "../baseComponents/AnimateInView";
      ...
      <SectionContainer>
        <AnimateInView>
          ...
          <p className="my-4">
            ...
            Hailing from the charming town of Ciamis. By day I'am a passionate
            agriculture student nurturing seeds of knowledge.{" "}
            <span className="text-primary text-2xl font-bold">
              By night, I transform into a web programming enthusiast, weaving
              digital landscapes.{" "}
            </span>
