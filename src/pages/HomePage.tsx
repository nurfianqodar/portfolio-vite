    ...
    <>
      <SectionContainer>
        <h1 className="text-base">
          ...
          <span className="text-4xl my-2 font-bold text-primary">
            <Typewriter
              options={{
                autoStart: true,
                strings: ["Nurfian Qodar", "Web Developer", "Farmer"],
                loop: true,
              }}
            />
          </span>
        ...
        <h2 className="font-light  mb-5">
          Combining <span className="font-semibold">sustainable farm</span> with
          IoT
        </h2>
        <HomeSocialMedia />
        ...
        <p className="my-6 text-xl font-light">
          <strong className="mb-5 font-bold">
            <span className="text-teal-500">Agriculture</span> Enthusiast and{" "}
            <span className="text-primary">Coding</span> Aficionao |
          </strong>{" "}
          Cultivating creativity in fields and code. Explore my portfolio, a
